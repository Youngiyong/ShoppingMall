		...
		<form action="updateBoard.do" method="post">
			...
			<table border="1" cellpadding="0" cellspacing="0" class="jm-font">
				...
				<tr>
					...
					<td align="left"><input name="b_title"  
						value="${board.b_title }" /></td>
				</tr>
				<tr>
					<td bgcolor="grey">그룹</td>
					<td align="left">${board.b_group }</td>
				</tr>
				<tr>
					<td bgcolor="grey">내용</td>
					<td align="left"><textarea id="summernote" name="b_content" cols="50" rows="40">${board.b_content }</textarea></td>
				</tr>
<!-- 				<tr> -->
