...
<head>
  ...
  <link href="/ShoppingMall/admin/assets/css/app-style.css" rel="stylesheet"/>
    ...
    <script src="/ShoppingMall/member/js/idsearch.js"></script>
</head>
		  ...
		  <div class="card-title text-uppercase pb-2">비밀번호 초기화</div>
		    ...
		    <form method="post" id="frm">
			  <div class="form-group">
                <label for="m_Id" class="">아이디</label>
                  <div class="position-relative has-icon-right">
                      <input type="text" id="m_Id" name="m_Id" class="form-control input-shadow" placeholder="아이디">
                      <div class="form-control-position">
                          <i class="icon-envelope-open"></i>
                      </div>
                  </div>
			  <label for="m_Email" class="">이메일</label>
			   <div class="position-relative has-icon-right">
				  <input type="text" id="m_Email" name="m_Email" class="form-control input-shadow" placeholder="이메일 주소">
				  <div class="form-control-position">
					  <i class="icon-envelope-open"></i>
				  </div>
			   </div>
		   ...
		   <div class="card-footer text-center py-3">
		    <p class="text-warning mb-0">로그인 페이지 <a href="/ShoppingMall/member/login.do"> 이동</a></p>
		  </div>
	     </div>
	     </div>
