...
<head>
  ...
  <title>세션 ID : ${sessionScope.a_Id}</title>
  <!-- loader-->
  ...
  <!-- Vector CSS -->
<%--  <link href="/ShoppingMall/admin/plugins/vectormap/jquery-jvectormap-2.0.2.css" rel="stylesheet"/>--%>
  <!-- simplebar CSS-->
       ...
       <li class="dropdown-item user-details">
        <a href="javaScript:void();">
           <div class="media">
            ...
            <h6 class="mt-2 user-title">${adminVO.a_Id}${vo.a_Id} ${sessionScope.a_Id} </h6>
...
<div class="clearfix"></div>
 ...
 <!-- simplebar js -->
  ...
  <!-- loader scripts -->
<%--  <script src="/ShoppingMall/admin/js/jquery.loading-indicator.js"></script>--%>
  <!-- Custom scripts -->
  <script src="/ShoppingMall/admin/assets/js/app-script.js"></script>
  <!-- Chart js -->
  
  <script src="/ShoppingMall/admin/assets/plugins/Chart.js/Chart.min.js"></script>
 
  <!-- Index js -->
  <script src="/ShoppingMall/admin/assets/js/index.js"></script>
